...
view : Info -> Docs.Block -> Element msg
view info block =
    case block of
        ...
        Docs.UnknownBlock name ->
            paragraph
                ...
                , link [] { label = text "here", url = "https://github.com/elm/package.elm-lang.org/issues" }
                , text " with the title “UnknownBlock found in docs” and with a link to this page in the description."
                ]


viewCodeBlock : String -> String -> List (Line msg) -> Element msg
...
viewValue : Info -> Docs.Value -> Element msg
viewValue info { name, comment, tipe } =
    ...
    viewCodeBlock name comment <|
        case toLines info Other tipe of
            One _ line ->
                [ nameElement :: space :: colon :: space :: line ]

            More x xs ->
                [ nameElement, space, colon ] :: indentFour x :: List.map indentFour xs
...
viewBinop : Info -> Docs.Binop -> Element msg
...
viewAlias : Info -> Docs.Alias -> Element msg
...
viewUnion : Info -> Docs.Union -> Element msg
...
makeInfo : String -> String -> V.Version -> String -> List Docs.Module -> Info
...
toBoldLink : Info -> String -> Element msg
toBoldLink info name =
    makeLink info [ Font.bold ] name name


makeLink : Info -> List (Attribute msg) -> String -> String -> Element msg
...
toLinkLine info qualifiedName =
    case Dict.get qualifiedName info.typeNameDict of
        Nothing ->
            ...
            in
            One (String.length shortName) [ el [ title qualifiedName ] <| text shortName ]
